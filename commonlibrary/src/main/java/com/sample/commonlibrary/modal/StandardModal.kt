package com.sample.commonlibrary.modal
...
import com.sample.commonlibrary.databinding.StandardModalBinding
import com.sample.commonlibrary.databinding.StandardModalFooterItemBinding
import com.sample.commonlibrary.databinding.StandardModalHeaderItemBinding
import com.sample.commonlibrary.databinding.StandardModalListItemBinding
...
class StandardModal (
        ...
        private val callbacks: Activity,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        DaggerViewModelDependencyInjector.builder()
                .viewModelInjectorModule(ViewModelInjectorModule(callbacks))
                .build()
                .inject(this)
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return object: Dialog(callbacks, theme) {
            override fun onBackPressed() {
                dismiss()
...
//    }
    ...
    class ModalListAdapter(private val callbacks: Activity, val uiViewModel: UIViewModel, val standardModal: StandardModal, val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            when (viewType) {
                ModalListType.HEADER_ITEM.ordinal -> {
                    ...
                    //uiViewModel.currentTheme = (callbacks as MainActivity).currentTheme
                ...
                ModalListType.LIST_ITEM.ordinal -> {
                    ...
                    binding.uiViewModel = uiViewModel
                    //uiViewModel.currentTheme = callbacks.currentTheme
